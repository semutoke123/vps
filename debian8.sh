...
state=NorthSumatera
locality=Nusantara
organization=Phreakers
organizationalunit=Army
commonname=Server
email=admin@apn.oulook.com
...
wget https://github.com/Mr-Kenyut/VPS/blob/master/badvpn-1.999.127.tar.bz2?raw=true
tar xf badvpn-1.999.127.tar.bz2
mkdir badvpn-build
cd badvpn-build
cmake ~/badvpn-1.999.127 -DBUILD_NOTHING_BY_DEFAULT=1 -DBUILD_UDPGW=1
make install
screen badvpn-udpgw --listen-addr 127.0.0.1:7200 > /dev/null &
cd
...
wget -q hhttps://raw.githubusercontent.com/Mr-Kenyut/VPS/master/drop-mon.sh
...
wget -q hhttps://raw.githubusercontent.com/Mr-Kenyut/VPS/master/user-limit.sh
wget -q https://raw.githubusercontent.com/Mr-Kenyut/VPS/master/del-user-expire.sh
wget -q hhttps://raw.githubusercontent.com/Mr-Kenyut/VPS/master/openvpn.sh
wget -q https://raw.githubusercontent.com/Mr-Kenyut/VPS/master/ocspanel.sh
...
echo -e "${LGREEN}Dropbear : ${NORMAL}444, 80, 110"  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "==========================================="  | tee -a log-install.txt
echo "    Reza Adrian (Whatsapp: 081214422324)    "  | tee -a log-install.txt
